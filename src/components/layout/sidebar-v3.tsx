...
const SCHOOL_NAV: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Grades & Results', href: '/dashboard/exams',        icon: Award,          permission: 'exams:read' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Notices',         href: '/dashboard/notifications',icon: Bell,           permission: 'notifications:read' },
